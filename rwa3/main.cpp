...
//fucntion prototype for FollowActionPath provided in the question
void FollowActionPath(rwa3::LandBasedRobot *robot, const std::vector<std::string> &vec, std::string obj);
//fucntion definition for FollowActionPath provided in the question
void FollowActionPath(rwa3::LandBasedRobot *robot, const std::vector<std::string> &vec,std::string obj){
...
int main(){
//	rwa3::LandBasedTracked landbasedtracked("hello",5,6,nullptr); 
//	rwa3::LandBasedWheeled landbasedwheeled("ohhlala",25,26,3,nullptr);
//	return 0;
